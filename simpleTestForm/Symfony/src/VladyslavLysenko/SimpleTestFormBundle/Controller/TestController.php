...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VladyslavLysenkoSimpleTestFormBundle:Test')->findAll();

        return $this->render('VladyslavLysenkoSimpleTestFormBundle:Test:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('VladyslavLysenkoSimpleTestFormBundle:Test:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('VladyslavLysenkoSimpleTestFormBundle:Test:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('VladyslavLysenkoSimpleTestFormBundle:Test:edit.html.twig', array(
            'entity'      => $entity,
